...
func getPushProviderConfig(t *testing.T) cc.PushProviderConfig {
	os.Setenv("BCS_HOST", "http://bcs-api.sit.bktencent.com/bcsapi/v4")
	os.Setenv("TOKEN", "SgE87pxszONSOrmiuclRcmE7eyujc6Zx")
	os.Setenv("DOMAIN", "bscp")
		...
		Event: PushEvent{
			...
			EventDetail: PushEventDetail{
				Fields: PushEventFields{
					Types:         "mail",
					MailReceivers: "gc_caoqiwen@ieggtc.com",
