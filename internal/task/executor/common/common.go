...
<span style="color:#2ecc71; font-weight:600;">%d 个成功</span>，
<span style="color:#e74c3c; font-weight:600;">%d 个失败</span>，
<span style="color:#f39c12; font-weight:600;">%d 个已完成</span>
`
...
func NewExecutor(gseService *gse.Service, dao dao.Set, pm pushmanager.Service) *Executor {
	return &Executor{
...
func buildTaskDetailURL(bizID uint32, batchID string) string {
	return fmt.Sprintf(
		"http://web.sit.bktencent.com:8090/bscp/ui/space/%d/task/detail/%s",
		bizID,
		batchID,
	)
}
