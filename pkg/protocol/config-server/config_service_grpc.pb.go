...
const (
	...
	Config_ListExpiredCertificateKvs_FullMethodName          = "/pbcs.Config/ListExpiredCertificateKvs"
...
type ConfigClient interface {
	...
	// 获取键值配置项证书过期列表
	ListExpiredCertificateKvs(ctx context.Context, in *ListExpiredCertificateKvsReq, opts ...grpc.CallOption) (*ListExpiredCertificateKvsResp, error)
	// 获取客户端列表
...
func (c *configClient) ListExpiredCertificateKvs(ctx context.Context, in *ListExpiredCertificateKvsReq, opts ...grpc.CallOption) (*ListExpiredCertificateKvsResp, error) {
	out := new(ListExpiredCertificateKvsResp)
	err := c.cc.Invoke(ctx, Config_ListExpiredCertificateKvs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConfigServer interface {
	...
	// 获取键值配置项证书过期列表
	ListExpiredCertificateKvs(context.Context, *ListExpiredCertificateKvsReq) (*ListExpiredCertificateKvsResp, error)
	// 获取客户端列表
...
func (UnimplementedConfigServer) ListExpiredCertificateKvs(context.Context, *ListExpiredCertificateKvsReq) (*ListExpiredCertificateKvsResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListExpiredCertificateKvs not implemented")
}
...
func _Config_ListExpiredCertificateKvs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListExpiredCertificateKvsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConfigServer).ListExpiredCertificateKvs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Config_ListExpiredCertificateKvs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigServer).ListExpiredCertificateKvs(ctx, req.(*ListExpiredCertificateKvsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Config_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListExpiredCertificateKvs",
			Handler:    _Config_ListExpiredCertificateKvs_Handler,
		},
		{
