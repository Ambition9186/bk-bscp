...
const (
	...
	Data_ListExpiredCertificateKvs_FullMethodName         = "/pbds.Data/ListExpiredCertificateKvs"
...
func (c *dataClient) ListExpiredCertificateKvs(ctx context.Context, in *ListExpiredCertificateKvsReq, opts ...grpc.CallOption) (*ListExpiredCertificateKvsResp, error) {
	out := new(ListExpiredCertificateKvsResp)
	err := c.cc.Invoke(ctx, Data_ListExpiredCertificateKvs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDataServer) ListExpiredCertificateKvs(context.Context, *ListExpiredCertificateKvsReq) (*ListExpiredCertificateKvsResp, error) {
...
func _Data_ListExpiredCertificateKvs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListExpiredCertificateKvsReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataServer).ListExpiredCertificateKvs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Data_ListExpiredCertificateKvs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataServer).ListExpiredCertificateKvs(ctx, req.(*ListExpiredCertificateKvsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Data_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Data_ListExpiredCertificateKvs_Handler,
		},
		{
